#include <bits/stdc++.h>
//basic idea: since we have low limits, we can just DFS starting from each start node, and only DFS the children if their associated relevence value is greater than our threshold. Rinse and repeat for each case.
using namespace std;
const int MAXN = 5000;
